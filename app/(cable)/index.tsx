...
export default function CableIndex() {
        ...
        <ScrollView
          ...
          <ListTile
            ...
            additionalNode={
              <View>
                <Image />
                <Text className="font-Satoshi-Bold text-md text-blue-500">DSTV</Text>
              </View>
            }
          />
          <ListTile
          ...
          <ListTile
            ...
            withArrow={false}
            additionalNode={
              <Text className="font-Satoshi-Bold text-md text-black-400">DSTV Compact</Text>
            }
          />
          <ListTile
            title="IUC / SmartCard Number: "
            withArrow={false}
            additionalNode={
        ...
        <View
          ...
          <CustomDropdown
            data={[
              ...
              { label: 'Premium Asia', value: '2' },
              { label: 'Box Office', value: '3' },
              { label: 'Padi', value: '4' },
            ]}
            label="Product"
            onValueChanged={() => {}}
          ...
          <AppInput
            ...
            label="Enter IUC / SmartCard Number"
          ...
          <View
            ...
            <Text className="text-center font-Satoshi-Bold text-md text-primary">
              20% Off when you purchase a Cable product from us!!!
            </Text>
          </View>
        </View>
